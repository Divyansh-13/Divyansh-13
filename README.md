...
class DivyanshSharma:
    def __init__(self):
        self.name        = "Divyansh Sharma"
        self.role        = "AI/ML Developer"
        self.location    = "India"
        self.email       = "sharmadivyansh022@gmail.com"

    def current_focus(self):
        return [
            "Advanced ML · MLOps · System Design",
            "End-to-end ML pipelines",
            "Cloud deployments: AWS, Firebase, Vercel",
        ]

    def achievements(self):
        return {
            "LeetCode"  : "500+ problems solved",
            "Certs"     : ["Oracle AI Vector Search", "OCI GenAI 2025",
                           "Cisco Cybersecurity"],
...
<p align="left">
  ...
  <a href="https://github.com/Divyansh-13" target="_blank">
...
<img width="40%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Divyansh-13&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" alt="Top Languages"/>
...
| 👁️ Computer Vision | Object Detection · Gesture Recognition · Segmentation |
| 🔤 NLP & LLMs | RAG Systems · Embeddings · Prompt Engineering |
| ☁️ Cloud & MLOps | AWS · Vercel · Firebase · Docker · CI/CD |
| 🏗️ Backend Systems | REST APIs · Next.js · System Design |
| 🧩 Competitive Prog. | DSA · LeetCode 500+ · Algorithmic Thinking |
